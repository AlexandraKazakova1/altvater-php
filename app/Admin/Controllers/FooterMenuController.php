...
class FooterMenuController extends MyAdminController {
	...
	protected function detail($id){
		header('Location: /admin/footer-menu/'.$id.'/edit');
		return;
	}
	...
	protected function form(){
		...
		$form->saving(function(Form $form){
			...
			if($form->sort < 1){
				$count = DB::table('footer-menu')->count();
				$count++;
