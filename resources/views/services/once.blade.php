	...
	<main>
			...
			<div class="breadcrumbs container">
				<ul class="breadcrumbs__list">
					...
					<li class="breadcrumbs__item active">
						<span>Вивіз побутового сміття з території ОСББ та приватного сектору</span>
		...
		<section class="osbb__wrapper">
			<div class="osbb container">
				<h2 class="section-title">Вивіз побутового сміття з території<br>ОСББ та приватного сектору</h2>
				<p class="section-text">Вивіз побутового сміття з території ОСББ та приватного сектору. Для цього використовується сучасний транспорт, який обладнаний за всіма стандартами. Вивіз здійснюється в строго встановлені терміни, що дозволяє підтримувати на території оптимальну чистоту.</p>
				<p class="section-text">Вивіз сміття з території комерційних структур, серед яких бізнес і торговельні центри, заклади громадського харчування. Зазвичай там утворюється великий об'єм сміття, який треба правильно вивезти і утилізувати.</p>
			</div>
		</section>
		...
		<section class="last-work__wrapper">
			<div class="last-work container">
				...
				<div class="last-work__slider slider">
					<!-- -->
					<div>
						<div class="last-work__photo"><img src="../img/slick/image1.png"></div>
					</div>
					<!-- -->
				</div>
				...
				<div class="comment">
					...
					<p class="section-text">Кріплені доступом до досвіду Veolia та перевірених технологій очищення води. Сучжоу ANFENG Екологічна технологія ТОВ є одним з нових партнерів для Китаю.</p>
				</div>
			</div>
		</section>
