...
@section('main')
	<main class="openContract__page">
		<section class="breadcrumbs__wrapper">
			<div class="breadcrumbs container">
				<ul class="breadcrumbs__list">
					...
					<li class="breadcrumbs__item"><a href="/account/contracts">Мої договори</a></li>
		...
		<h1 class="page__title">{{$contract->file_name}}</h1>
		
		<a class="back-link wb" href="/account/contracts">
		...
		<section class="openAccounts">
			...
			<div class="account__wrapper">
				<embed src="/storage/{{$contract->file}}" width="100%" height="1500px" />
			</div>
		</section>
	</main>
@stop
