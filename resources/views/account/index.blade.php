		...
		<div class="content__wrapper">
			<div class="content">
				...
				<section class="calendar__wrapper">
					<div class="title__wrapper with-select">
						<h2 class="section__title">Календар послуг</h2>
					...
					<div id="scheduler__calendar" class="dhx_cal_container" style='width:100%; height:450px;'>
						<div class="dhx_cal_navline">
							<div class="dhx_cal_prev_button"><img src="/img/arrow_left.svg" alt=""></div>
							<div class="dhx_cal_next_button"><img src="/img/arrow_left.svg" alt=""></div>
					...
					<ul class="addresses__list">
						@foreach($addresses as $item)
							...
							<li class="list__item" data-id="{{$item->id}}">
								...
								<button class="btn-more btn-address__info" data-id="{{$item->id}}" data-name="{{$item->name}}" data-address="{{$item->address}}" data-toggle="modal" data-target="#address__info-modal">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
